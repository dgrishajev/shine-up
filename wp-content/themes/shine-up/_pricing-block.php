<div id="pricing-block" class="pricing-block">
  ...
  <div class="block-inner-wrap">
    ...
    <div class="inner-block plus">
      ...
      <div class="pricing-divider"></div>
      <p class="pricing-description">Som ”Premium” endvidere voks og polering af alle gelcoat overflader.</p>
    </div>

  </div>

  <p class="underline">FOR EVERY OTHER TYPE OF SERVICE</p>

  <div class="other-service">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/build/img/clock.svg">
    <h1>540dk/t</h1>
  </div>

  <p class="pricing-description bottom">Priserne kan variere afhængig af bådens tilstand og placering. Hvis båden er mere ”krævende” kan prisen blive højere end ovennævnte. Vi vurderer standen af båden og tilbyder prisoverslag. Inklusive Moms (25%)*</p>
